...
class Constants {
   public:
    static const constexpr char* const WORDS[] = {
    ...
    static const constexpr double FREQ[] = {
        0.0845788, 0.0242765, 0.0412095, 0.0339525,  0.106523,  0.0198704,
        0.0268683, 0.0336069, 0.0579698, 0.00233261, 0.0181425, 0.0621166,
        0.0273002, 0.049676,  0.0651404, 0.0317063,  0.0025054, 0.0776674,
        0.057797,  0.0629806, 0.0403456, 0.0132181,  0.0168467, 0.00319654,
        0.0367171, 0.00345572};

    static const constexpr size_t FREQ_COUNT = ARR_LEN(FREQ);
};